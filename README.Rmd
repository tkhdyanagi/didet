...
The package enables to implement the doubly robust estimation of the 
average treatment effect for movers using the concept of effective treatment.
For more details,
see [Yanagi (2023) "An effective treatment approach to difference-in-differences with general treatment patterns"](https://doi.org/10.48550/arXiv.2212.13226).
